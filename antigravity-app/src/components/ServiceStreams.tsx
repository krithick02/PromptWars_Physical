                ...
                >
                    <div className="flex items-center gap-5">
                        ...
                        <div className="text-left">
                            ...
                            <p className="text-[10px] text-[#52525b] font-bold uppercase tracking-[0.3em] leading-none mt-2">Active Requests</p>
                        </div>
                    </div>
                    <motion.div 
                    ...
                    {isOpen && (
                        ...
                        >
                            <div className="pt-2 flex flex-col gap-4">
                                {STREAMS.map(item => (
                                    <div key={item.id} className="relative p-6 rounded-2xl bg-[#09090b] border border-white/[0.03] flex justify-between items-center group hover:border-[#c2a87e]/20 transition-all">
                                        <div>
                                            ...
                                            <p className="text-[10px] text-[#52525b] uppercase font-bold tracking-[0.2em]">{item.lane}</p>
                                        </div>
                                        <div className="text-right">
                                            <span className="text-[#fafafa] font-light text-3xl tabular-nums leading-none tracking-tighter">{item.pending}</span>
                                            <p className="text-[10px] text-[#c2a87e]/60 uppercase tracking-widest font-bold mt-2">Active</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
